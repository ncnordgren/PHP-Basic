...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if (!isset($error_message)) 
    {
      ...
      $mail->addAddress('treehouse@localhost', 'Nancy');     // Add a recipient
      ...
      <h1>Suggest a Media Item</h1>
       <?php 
          ...
          { 
              ...
              {
                echo "<p>If you think there is something I&rsquo;m missing, let me know! Fill out the form below and send me an email.</p>";
              }
          ?>
        ...
        <table>
           ...
           <tr>
            ...
            <td><select id="format" name="format">
                ...
                <optgroup label="Books">
                  <option value="Audio"
                    <?php if (isset($format) && $format == "Audio")
                      {echo " selected";}?>>Audio</option>
                  <option value="Ebook"
                    <?php if (isset($format) && $format == "Ebook")
                      {echo " selected";}?>>Ebook</option>
                  <option value="Hardback"
                    <?php if (isset($format) && $format == "Hardback")
                      {echo " selected";}?>>Hardback</option>
                  <option value="Paperback"
                    <?php if (isset($format) && $format == "Paperback")
                      {echo " selected";}?>>Paperback</option>              
                </optgroup>
                <optgroup label="Movies">
                  <option value="Blu-ray"
                    <?php if (isset($format) && $format == "Blu-ray")
                      {echo " selected";}?>>Blu-ray</option>
                  <option value="DVD"
                    <?php if (isset($format) && $format == "DVD")
                      {echo " selected";}?>>DVD</option>
                  <option value="Streaming"
                    <?php if (isset($format) && $format == "Streaming")
                      {echo " selected";}?>>Streaming</option>
                  <option value="VHS"
                    <?php if (isset($format) && $format == "VHS")
                      {echo " selected";}?>>VHS</option>              
                </optgroup>
                <optgroup label="Music">
                  <option value="Cassette"
                    <?php if (isset($format) && $format == "Cassette")
                      {echo " selected";}?>>Cassette</option>
                  <option value="CD"
                    <?php if (isset($format) && $format == "CD")
                      {echo " selected";}?>>CD</option>
                  <option value="MP3"
                    <?php if (isset($format) && $format == "MP3")
                      {echo " selected";}?>>MP3</option>                  
                  <option value="Vinyl"
                    <?php if (isset($format) && $format == "Vinyl")
                      {echo " selected";}?>>Vinyl</option>
                </optgroup>
             </select></td>
          </tr>
           <tr>
          ...
          <tr>
            ...
            <td><textarea id="details" name="details">
              <?php if (isset($details)) {echo $details;} ?></textarea></td>
          </tr>
